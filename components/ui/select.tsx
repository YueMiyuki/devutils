  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        `,
        "[&_svg:not([class*='text-'])]:text-muted-foreground/50",
        ...
        `,
        `
          flex w-fit items-center justify-between gap-2 rounded-xl border px-4
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          `
            border-foreground/10 bg-popover/95 text-popover-foreground
            backdrop-blur-xl
          `,
          `
          ...
          `
            ...
            overflow-y-auto
          `,
          "rounded-xl border shadow-lg shadow-foreground/5",
          position === "popper" &&
            `
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "[&_svg:not([class*='text-'])]:text-muted-foreground/50",
        `
          relative flex w-full cursor-pointer items-center gap-2 rounded-lg py-2
          pr-8 pl-3 text-sm
        `,
        "outline-hidden transition-colors duration-150 select-none",
