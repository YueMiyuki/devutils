...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        `
          inline-flex h-10 w-fit items-center justify-center rounded-xl border
          border-foreground/5 bg-foreground/3 p-1 text-muted-foreground
        `,
        className,
      )}
      {...props}
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        `,
        "data-[state=active]:border-foreground/10",
        `
